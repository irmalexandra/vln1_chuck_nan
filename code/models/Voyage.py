...
class Voyage():
    ...
    def __str__(self):
        return "Destination: {:>2} \nAirplane: {:>2} \nDeparture: {:>2} \nReturn: {:>2} \nPilot: {:>2} \nCo-pilot: {:>2} \nFlight service manager: {:>2} \nCabin crew: {:>2} \nStatue: ".format(self.__destination, self.__airplane, self.__departure, self.__return, self.__pilot, self.__co_pilot, self.__sfm, self.__cabin_crew_list, self.__status)
