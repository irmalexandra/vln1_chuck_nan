...
class UIMain():
    ...
    def __init__(self):
        ...
        self.__ui_employees = UIEmployees(self.__LLAPI, self.__modelAPI, self.__ui_base_functions)
        self.__ui_voyages = UIVoyages(self.__LLAPI, self.__modelAPI, self.__ui_base_functions)
        self.__ui_destinations = UIDestinations(self.__LLAPI, self.__modelAPI, self.__ui_base_functions)
        self.__ui_airplanes = UIAirplanes(self.__LLAPI, self.__modelAPI, self.__ui_base_functions)
    ...
    def display_main_menu(self):
        while True:
            nav_dict = {1:self.__ui_employees.display_employee_sub_menu,2:self.__ui_voyages.display_voyage_sub_menu,3:self.__ui_destinations.display_destination_sub_menu,4:self.__ui_airplanes.display_airplanes_sub_menu,0:self.exit_program}
